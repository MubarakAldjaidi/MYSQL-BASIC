...
-- Opdracht 3
SELECT name, genre, NA_Sales FROM videogamesales WHERE genre = "sports"
-- Opdracht 4
...
-- Opdracht 10
SELECT avg(NA_Sales) as NAmerika, AVG(EU_Sales) as Europa, avg(JP_Sales) as japan FROM `videogamesales` WHERE publisher = 'Sony Computer Entertainment'
-- Opdracht 11
